...
class RegisterController extends BaseController
{
    ...
    {
        try {
            $data = Register::join('conferences', 'conferences.id', '=', 'registers.conferences_id')->select('registers.id', 'registers.conferences_id', 'name', 'registers.title', 'registers.email', 'alternative_email', 'phone_number', 'whatsapp_number', 'institution', 'registers.country_id')->where(function ($query) use ($request) {
