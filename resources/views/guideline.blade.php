...
@section('title', 'Guideline Details')
        ...
        <div class="row align-items-center justify-content-center extra-small-screen">
            <div class="col-lg-8 text-center page-title-extra-large">
                <h1 class="mb-0 text-white alt-font fw-600 ls-minus-5px">
                    <span class="d-block text-outline text-outline-width-2px text-outline-color-white" data-fancy-text='{ "string": ["Guideline"], "duration": 500, "delay": 0, "speed": 50, "clipPath": ["inset(0 500px 0 0)", "inset(0px -5px 0px 0px)"], "easing": "easeOutCubic" }'></span>
                                ...
                                <div class="accordion accordion-style-02" id="accordion-style-01">
                                    <div class="accordion-item active-accordion">
                                        <div class="accordion-title mb-0 position-relative">
                                            <div class="ql-editor">
                                                {!! $conferenceOtherInformation->guidelines_description !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>           
