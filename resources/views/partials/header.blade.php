                    ...
                    <ul class="navbar-nav alt-font ls-05px">
                        ...
                        <li class="nav-item dropdown dropdown-with-icon">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                <li>
                                    <a href="demo-conference-speaker-details.html"><img src="https://via.placeholder.com/200x200" alt="">
                                ...
                                <li>
                                    <a href="demo-conference-speaker-details.html"><img src="https://via.placeholder.com/148x148" alt="">
                                        <div class="submenu-icon-content">
