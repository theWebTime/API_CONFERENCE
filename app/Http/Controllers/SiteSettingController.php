...
class SiteSettingController extends BaseController
{
    public function updateOrCreateSiteSetting(Request $request)
    {
        ...
        try {
            ...
            $validator = Validator::make($input, [
                ...
                'x_link' => 'nullable|max:200|url',
                'linkedin_link' => 'nullable|max:200|url',
            ...
            $updateData = (['email1' => $input['email1'], 'email2' => $input['email2'], 'phone_number1' => $input['phone_number1'], 'phone_number2' => $input['phone_number2'], 'address' => $input['address'], 'iframe' => $input['iframe'], 'video_link' => $input['video_link'], 'facebook_link' => $input['facebook_link'], 'x_link' => $input['x_link'], 'linkedin_link' => $input['linkedin_link'], 'youtube_link' => $input['youtube_link'], 'whatsapp_number' => $input['whatsapp_number'], 'instagram_link' => $input['instagram_link']]);
    ...
    {
        try {
            $data = SiteSetting::select('logo',  'email1', 'email2', 'phone_number1', 'phone_number2', 'address', 'iframe', 'video_link', 'facebook_link', 'instagram_link', 'x_link', 'linkedin_link', 'youtube_link', 'whatsapp_number')->first();
            if (is_null($data)) {
